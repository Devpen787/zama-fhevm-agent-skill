...
describe("ConfidentialVotingExample", () => {
  async function deployFixture() {
    ...
    const factory = await ethers.getContractFactory("ConfidentialVotingExample");
  ...
  it("rejects encrypted input when it was created for a different contract address", async () => {
    ...
    const secondFactory = await ethers.getContractFactory("ConfidentialVotingExample");
